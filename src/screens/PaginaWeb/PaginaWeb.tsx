...
export const PaginaWeb = (): JSX.Element => {
  return (
    <div className="w-full bg-[#e6e900] overflow-x-hidden">

      <section className="relative w-full bg-[#e6e900] pt-4 pb-6">
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-4 items-start">
            <div className="w-full md:w-1/3 flex flex-col gap-4">
              <div className="text-[24px] md:text-[32px] font-bold text-black -rotate-2">
                IN LEGAL TROUBLE?
              </div>
              <img
              ...
              <div className="flex flex-col gap-2">
                ...
                <span className="text-[12px] md:text-[14px] text-black -rotate-2">
                  (NOT TOLL FREE)
                </span>
              </div>
            </div>
            ...
            <div className="w-full md:w-2/3 flex flex-col gap-4">
              <div className="relative bg-[#d01313] rounded-lg p-4 md:p-6 text-center">
                <div className="text-[20px] md:text-[28px] font-bold text-[#e6e900]">
                  (505) 503 - 4405 - SE HABLA ESPANOL
                </div>
              </div>

              <div className="flex flex-col md:flex-row gap-3">
                <a href="https://bettercallsaul-contact.com" target="_blank" rel="noopener noreferrer" className="no-underline flex-1">
                  <div className="w-full bg-black text-[#e6e900] font-bold py-3 px-4 text-center cursor-pointer transition-all hover:bg-[#e6e900] hover:text-black -rotate-2">
                    CONTACT US
                  </div>
                </a>
                <a href="https://bettercallsaul-location.com" target="_blank" rel="noopener noreferrer" className="no-underline flex-1">
                  <div className="w-full bg-black text-[#e6e900] font-bold py-3 px-4 text-center cursor-pointer transition-all hover:bg-[#e6e900] hover:text-black -rotate-2">
                    LOCATION
                  </div>
                </a>
                <a href="https://bettercallsaul-info.com" target="_blank" rel="noopener noreferrer" className="no-underline flex-1">
                  <div className="w-full bg-black text-[#e6e900] font-bold py-3 px-4 text-center cursor-pointer transition-all hover:bg-[#e6e900] hover:text-black -rotate-2">
                    MORE INFO.
                  </div>
                </a>
      ...
      <section className="relative w-full bg-[#e6e900] py-8 md:py-12">
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
            <div className="w-full md:w-[45%] flex flex-col gap-4">
              <div className="bg-black p-4 md:p-6">
                <h3 className="text-[20px] md:text-[28px] font-bold text-[#e6e900] mb-4">
                  LAW AND SAUL:
                </h3>
                <p className="text-[14px] md:text-[16px] text-[#e6e900] leading-relaxed">
                  The shadowy underbelly of Albuquerque's legal landscape is where Saul Goodman operates. A name synonymous with cunning, charisma, and unyielding advocacy for those entangled in the web of criminal accusations. Saul Goodman isn't just a lawyer; he's a lifeline for the desperate, the accused, and the overlooked, operating under the banner of his iconic firm, "Better Call Saul."
                </p>
              </div>
              ...
              <div className="text-[14px] md:text-[18px] font-bold text-black">
                - SAUL GOODMAN
              </div>
            </div>
            ...
            <div className="w-full md:w-[55%] flex flex-col gap-4">
              ...
              <article className="text-[14px] md:text-[16px] text-black leading-relaxed text-justify">
                ...
                approach is holistic: it begins with an initial consultation that's
                as discreet as it is thorough, where he listens intently to your story,
                dissecting every detail to uncover angles that others might miss.
              </article>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
            <div className="w-full md:w-[45%]">
              <div className="bg-black p-4 md:p-6 mb-4">
                <h3 className="text-[20px] md:text-[28px] font-bold text-[#e6e900] mb-4">
                  THE WORLD ACCORDING TO SAUL GOODMAN
                </h3>
                <p className="text-[14px] md:text-[16px] text-[#e6e900] leading-relaxed">
                  ...
                  kitschy décor, and a constant hum of activity.
                </p>
              </div>
      ...
      <footer className="relative w-full bg-[#d01313] py-8 text-center">
        <div className="text-[18px] md:text-[22px] font-bold text-[#e6e900] mb-4">
          ©Copyright. Better Call Saul LTDA.
        </div>
        <a
          href="mailto:name555125@gmail.com"
          className="text-[16px] md:text-[20px] font-bold text-[#e6e900] no-underline hover:underline"
        >
